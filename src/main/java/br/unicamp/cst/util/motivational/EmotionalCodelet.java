...
public abstract class EmotionalCodelet extends Codelet {
    ...
    private String id;
    private br.unicamp.cst.motivational.Drive affectedDrive;
    ...
    public EmotionalCodelet(String id) throws CodeletActivationBoundsException {
        ...
        setAffectedDrive(new br.unicamp.cst.motivational.Drive(id));
    }
    ...
    public void accessMemoryObjects() {
        ...
        if (getInputAffectedDriveMO() == null) {
            ...
            setAffectedDrive((br.unicamp.cst.motivational.Drive) ((Memory)getInputAffectedDriveMO().getI()).getI());
        }
    ...
    public abstract double calculateEmotionalDistortion(List<br.unicamp.cst.motivational.Drive> listOfDrives, Mood mood);
    ...
    public synchronized void calculateActivation() {
        ...
        for (Map.Entry<Memory, Double> drive : getInputDrives().entrySet()) {
            listOfDrives.add((br.unicamp.cst.motivational.Drive) ((Memory)drive.getKey()).getI());
        }
    ...
    public br.unicamp.cst.motivational.Drive getAffectedDrive() {
