...
public class IdeaEditor extends javax.swing.JFrame {
    ...
    private void initEditTree() {
        ...
        editTreeIdea.addIdeaNode(new Idea("Episode","Existence", "Episode", 1));
        editTreeIdea.addIdeaNode(new Idea("Episode","Category", "Episode", 2));
        editTreeIdea.addIdeaNode(new Idea("Episode","Possibility", "Episode", 0));
        editTreeIdea.addIdeaNode(new Idea("TimeStep","", "TimeStep", 1));
        editTreeIdea.addIdeaNode(new Idea("Object","Existence", "AbstractObject", 1));
        editTreeIdea.addIdeaNode(new Idea("Object","Category", "AbstractObject", 2));
        editTreeIdea.addIdeaNode(new Idea("Object","Possibility", "AbstractObject", 0));
        editTreeIdea.addIdeaNode(new Idea("Property","Existence", "Property", 1));
        editTreeIdea.addIdeaNode(new Idea("Property","Category", "Property", 2));
        editTreeIdea.addIdeaNode(new Idea("Property","Possibility", "Property", 0));
        editTreeIdea.addIdeaNode(new Idea("QualityDimension","", "QualityDimension", 1));
        editTreeIdea.addIdeaNode(new Idea("Action","Possibility", "Action", 0));
        editTreeIdea.addIdeaNode(new Idea("Action","Existence", "Action", 1));
        editTreeIdea.addIdeaNode(new Idea("Action","Category", "Action", 2));
        editTreeIdea.addIdeaNode(new Idea("Goal","", "Goal", 1));
        editTreeIdea.addIdeaNode(new Idea("Link","Existence", "Link", 1));
        editTreeIdea.addIdeaNode(new Idea("Composite","", "Composite", 1));
        editTreeIdea.addIdeaNode(new Idea("Aggregate","", "Aggregate", 1));
        editTreeIdea.addIdeaNode(new Idea("Configuration","", "Configuration", 1));
